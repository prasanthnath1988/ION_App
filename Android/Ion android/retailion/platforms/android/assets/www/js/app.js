//Developed By Amit Kumar Pati//Mob-7205858208
...
var usageStatistics = angular.module('usageStatistics', ['ui.directives']);
var userProfile = angular.module('userProfile', []);

var ion=angular.module('ION', ['ionic','ionic-datepicker','ionic-timepicker',
'landing',
'help',
'sideMenu',
'walkthrough',
...
//  }
  ...
  $ionicPlatform.registerBackButtonAction(function () {
		...
		if($state.current.name == 'landing' || $state.current.name == 'login' || $state.current.name == 'walkthrough'){
			...
			$state.go('landing');
		else if($state.current.name == 'sessionDetails')
			$state.go('usageStatistics');
